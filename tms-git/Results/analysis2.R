setwd("/Users/jongminlee/Desktop/Files/nee_lab/DDM/tms3/Results")
...
# Set paths
basePath <- "/Users/jongminlee/Desktop/Files/nee_lab/DDM/tms3/Results"
...
traces.cat <- bind_rows(
  ...
  mutate(study = factor(study, levels=c("tms")),
         fair = factor(fair, levels=c("visit1", "visit2", "visit3", "visit4"))) %>%
  select(study, fair,
         vA = v_Intercept,

...
# Set paths
basePath <- "/Users/jongminlee/Desktop/Files/nee_lab/DDM/tms/"
...
traces.cat <- bind_rows(
  ...
  select(study, fair,
         ...
         v1 = `v_C(cond, Treatment('Delay'))[T.Switch]`,
         v2 = `v_C(cond, Treatment('Delay'))[T.Base]`,
         aA = a_Intercept,
         a0 = `a_C(cond, Treatment('Delay'))[T.Dual]`,
         a1 = `a_C(cond, Treatment('Delay'))[T.Switch]`,
         a2 = `a_C(cond, Treatment('Delay'))[T.Base]`,
         t) %>%
  group_by(study, fair) %>%
  nest() %>%
